...
# 创建Node文件
NODE_FILE_PUB="${PKG_NAME}/src/${PKG_NAME}/${PKG_NAME}/${NODE_NAME}Publisher.py"
NODE_FILE_SUB="${PKG_NAME}/src/${PKG_NAME}/${PKG_NAME}/${NODE_NAME}Subscriber.py"
...
# 更新setup.py文件
SETUP_PY="${PKG_NAME}/src/${PKG_NAME}/setup.py"
